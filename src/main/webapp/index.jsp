...
<body>
<div id="header">
    <p style="margin:150px auto"><a>Reference</a></p>
    <hr>
    <br>
    <ul style="font-size: 30px;">
        ...
        <br>
        <li>
            <a href="http://zyl-me.xicp.net:99/">GitLab</a>
        </li>
        <br>
        <li>
            <a href="../eclipse-plugin">Eclipse plugin</a>
        </li>
        <br>
        <li>
            <a href="../flappybird">Flappy Bird Game</a>
        </li>
        <br>
    </ul>
